...
SITE_URL = "https://membertools.com"
...
# - absolute urls eg 'http://membertools.com/dashboard'
...
INSTALLED_APPS += ["eveuniverse", "memberaudit", "membertools"]

# Register an application at https://developers.eveonline.com for Authentication
# & API Access and fill out these settings. Be sure to set the callback URL
# to https://membertools.com/sso/callback substituting your domain for membertools.com
...
# Set the default from email to something like 'noreply@membertools.com'
